...
const images = [
  { src: '../assets/images/projects/selenium-recyclink/add_remove_operation.png', alt: 'Google Chrome being controlled by Selenium showing a web page' },
  { src: '../assets/images/projects/selenium-recyclink/pytest_result.png', alt: 'Test execution results indicating all results passed' },
  { src: '../assets/images/projects/selenium-recyclink/sample_code.png', alt: 'Image shows the sample code of the specific project' }
];
