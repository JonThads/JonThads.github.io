...
const images = [
  { src: '../assets/images/projects/tryhackme/profile.png', alt: 'The page indicates my TryHackMe Profile with all completed rooms and achievements' },
  { src: '../assets/images/projects/tryhackme/skills_matrix.png', alt: 'The page displays my current skills matrix status' },
  { src: '../assets/images/projects/tryhackme/soc_lessons.png', alt: 'The page displays my current lesson status for the SOC Lesson' }
];
